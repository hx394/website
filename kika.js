...
function sayHello(evt){
  ...
  function chat(evt){
    ...
    function boyfriend(evt){
      ...
      forBalloon.appendChild(balloon);
      document.getElementById("kika").remove();
      var kika=document.createElement("img");
      kika.setAttribute("src","img/kika/kika_shy.png");
      kika.setAttribute("id","kika");
      myPet.appendChild(kika);
    }
    function girlfriend(evt){
      ...
      document.getElementById("kika").remove();
      var kika=document.createElement("img");
      kika.setAttribute("src","img/kika/kika_kill.png");
      kika.setAttribute("id","kika");
      myPet.appendChild(kika);
    }
    function stranger(evt){
      ...
      document.getElementById("kika").remove();
      var kika=document.createElement("img");
      kika.setAttribute("src","img/kika/kika_gun.png");
      kika.setAttribute("id","kika");
      myPet.appendChild(kika);
      ...
      function secret(evt){
        ...
        document.getElementById("kika").remove();
        var kika=document.createElement("img");
        kika.setAttribute("src","img/kika/painting.png");
        kika.setAttribute("id","kika");
        kika.setAttribute("width","278px");
        myPet.appendChild(kika);
      }
    }
  }
  function tea(evt){
    ...
    document.getElementById("kika").remove();
    var kika=document.createElement("img");
    kika.setAttribute("src","img/kika/kika_tea.png");
    kika.setAttribute("id","kika");
    myPet.appendChild(kika);
  }
}
